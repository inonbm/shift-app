...
interface WorkoutsTabProps {
  ...
  /** Whether this trainee is currently permitted to delete their own sessions */
  ...
  /** Called when trainer toggles the per-trainee delete permission */
  onToggleCanDelete: (value: boolean) => void;
}
...
export function WorkoutsTab({
  ...
  const handleTogglePermission = async () => {
    ...
    try {
      await onToggleCanDelete(!canDeleteSessions);
    } finally {
